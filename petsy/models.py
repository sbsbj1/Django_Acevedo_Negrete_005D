...
class Cliente(models.Model):
    ...
    Correo = models.CharField(max_length=30, verbose_name='Correo', unique=True, null=True)
    Telefono = models.IntegerField(verbose_name='Telefono', unique=True, null=True)
    Direccion = models.CharField(max_length=60, verbose_name='Direccion', unique=True, null=True)
